...
//     // —ейчас "fromServer" становитс€ объектом, возвращаемым маршрутом someway.json
...
var Clake = function() {
    ...
    // это обратный вызов, выполн€етс€ при ответе сервера
    //console.log("ѕолучение данных с сервера");
    window.alert("ѕолучение "+response);
    });
};
...
$(".tabs a:nth-child(1)").on("click", function () 
   ...
   {	
    ...
    $("main .content").empty();
    // возвращаетс€ false, так как мы не переходим по ссылке
